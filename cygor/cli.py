...
def _print_help():
    ...
    if ws:
        ...
        hint.append("cygor workspace create <path>", style=f"bold {BLUE}")
        console.print(hint)
    console.print()
    ...
    if not ws:
        ...
        steps = [
            ("1.", "Set a workspace:",      "cygor workspace create ~/cygor-engagement-1"),
...
def _workspace_status_plain() -> str:
    ...
    return (
        "  Workspace: not set\n"
        "    Set one with: cygor workspace create <path>\n"
    )
