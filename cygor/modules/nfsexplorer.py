    ...
    def enum_shares_only(self):
        try:
            ...
            if should_save and all_results:
                ...
                fmt = self.args.nfs_output_format if self.args.nfs_output_format else "text"
                save_results(self.host, all_results, outdir, f"nfsexplorer_{self.host}", fmt)
    ...
    def enum_share_files(self, args):
        try:
            ...
            if should_save and all_results:
                ...
                fmt = args.nfs_output_format if args.nfs_output_format else "text"
                save_results(self.host, all_results, outdir, f"nfsexplorer_{self.host}_files", fmt)
