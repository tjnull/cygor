...
- [`docs/examples/modules/example_simple.py`](https://github.com/tjnull/cygor/blob/dev/docs/examples/modules/example_simple.py)
  — minimal plugin (pings each target).
- [`docs/examples/modules/example_wrapper.py`](https://github.com/tjnull/cygor/blob/dev/docs/examples/modules/example_wrapper.py)
  — wraps an external CLI tool (`dig`) and parses the output.
- [`docs/examples/modules/template_module.py`](https://github.com/tjnull/cygor/blob/dev/docs/examples/modules/template_module.py)
...
See [`docs/examples/modules/example_wrapper.py`](https://github.com/tjnull/cygor/blob/dev/docs/examples/modules/example_wrapper.py)
